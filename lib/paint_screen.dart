...
import 'package:skribblio/final_leaderboard.dart';
import 'package:skribblio/home_screen.dart';
import 'package:skribblio/models/my_custom_painter.dart';
import 'package:skribblio/models/touch_points.dart';
import 'package:skribblio/player_score.dart';
import 'package:skribblio/waiting_lobby_screen.dart';
...
class _PaintScreenState extends State<PaintScreen> {
  ...
  void connect() {
    _socket = IO.io('http://192.168.70.252:3000', <String, dynamic>{
