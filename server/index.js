...
const DB = "mongodb+srv://skshitij269:abhwHLWYsSMoeTII@skribble.bxyxz5u.mongodb.net/?retryWrites=true&w=majority&appName=Skribble";
    ...
    socket.on('join-game', async({nickname, name}) => {
        try {
            ...
            if(room.isJoin) {
                ...
                room = await room.save();
                i
                 o.to(name).emit('updateRoom', room);
            } else {
